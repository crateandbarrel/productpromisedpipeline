...
import (
	...
	"github.com/cfrye2000/productPromisedEventMS/external/github.com/rs/xhandler"
	"github.com/cfrye2000/productPromisedEventMS/external/golang.org/x/net/context"
)
...
func (c *Cors) handlePreflight(w http.ResponseWriter, r *http.Request) {
	headers := w.Header()
	c.logf("  Preflight request headers submitted: %v", r.Header)
	...
	c.logf("  Preflight response headers: %v \n", headers)
}

// handleActualRequest handles simple cross-origin requests, actual request or redirects
func (c *Cors) handleActualRequest(w http.ResponseWriter, r *http.Request) {
	headers := w.Header()
	c.logf("  Actual request headers submitted: %v", r.Header)
	origin := r.Header.Get("Origin")
